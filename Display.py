...
class Display:
    def __init__(self):
        ...
        self.seek_text_label = tkinter.Label(self.root, textvariable=self.seek_text)
        self.forward_one_sec_button = tkinter.Button(progress_frame, command=self.forward_one_sec_callback, text='+1')
        self.forward_sixty_sec_button = tkinter.Button(progress_frame, command=self.forward_sixty_sec_callback, text='+60')
    ...
    def update_layout(self):
        ...
        self.seek_text_label.grid(column=0, row=3)
